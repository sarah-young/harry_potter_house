...
def unique_houses(filename):
    ...
    for line in house_data:
        ...
        if student_data_list[2] != "":
            house = student_data_list[2]
            houses.add(house)
...
def sort_by_cohort(filename):
    ...
    with open(filename) as house_data:
        ...
        for line in house_data:
            ...
            if student_data[-1] == "Winter 2016":
                winter_16.append(student_data[0] + " " + student_data[1])
            elif student_data[-1] == "Spring 2016":
                spring_16.append(student_data[0] + " " + student_data[1])
            elif student_data[-1] == "Summer 2016":
                summer_16.append(student_data[0] + " " + student_data[1])
            elif student_data[-1] == "Fall 2015":
                fall_15.append(student_data[0] + " " + student_data[1])
            elif student_data[-1] == 'G':
                ghosts.append(student_data[0] + " " + student_data[1])
